...
Welcome to [Zettel Notes](https://www.zettelnotes.com/) Markdown Note taking app for android

> Zettel notes provides seamless private zettelkasten and markdown note taking experience with synchronization and encryption. It is
> provided free of cost, without ads and with no hidden permissions. No user data is collected.

Notes are stored as separate markdown files (no vendor lock-in like other apps). You should create a new repository selecting your existing
notes folder from the Repositories option in menu.
...
- Synchronization
    - Dropbox
    - Git sync with Github, Gitlab and any private git repository
    - SFTP
    - WebDAV
- Encryption
    - PGP key
...
- [Documentation](https://www.zettelnotes.com)
