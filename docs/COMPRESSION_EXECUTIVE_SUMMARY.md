...
**Root issue:** Both systems *appear* to compress highly, but only one actually compresses intelligently. Auto-Dream is "truncation with a timer," not "intelligent compression."
