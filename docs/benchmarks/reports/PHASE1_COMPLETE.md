...
**Runner & Documentation:** 6. ✅ `scripts/run-baseline-experiment.ts` — Executable evaluation script 7. ✅ `MOLLY_AGI_BENCHMARKING_PHASE1.md` — Complete implementation guide
