...
description:
  'Bypasses SSL/TLS certificate pinning implementations in Android and
...
Java.perform(function () {
  ...
  try {
    ...
    NetworkSecurityConfig.isCleartextTrafficPermitted.implementation =
      function () {
        return true;
      };
  } catch (e) {}
        ...
        Interceptor.attach(match.address, {
          onEnter: function (args) {
            ...
            var trust = new ObjC.Object(args[3])
              ...
              .serverTrust();
            var credential =
              ObjC.classes.NSURLCredential.credentialForTrust_(trust);
