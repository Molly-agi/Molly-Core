...
description:
  'Implements secure API key generation, storage, rotation, and revocation
...
| **Key Prefix**      | An identifiable prefix (e.g., sk*live*) that enables automated detection of leaked keys in logs, code, and public repositories |
...
1. Implement prefixed API keys (sk*live*, sk*test*) with 256-bit entropy for leak detection
