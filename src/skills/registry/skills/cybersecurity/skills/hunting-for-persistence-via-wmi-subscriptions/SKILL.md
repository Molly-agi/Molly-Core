...
| \_\_EventFilter             | WMI class defining the trigger condition             |
| \_\_EventConsumer           | WMI class defining the action to perform             |
| \_\_FilterToConsumerBinding | Links a filter to a consumer                         |
...
3. **FIN8 WMI Timer**: Interval-based \_\_IntervalTimerEvent triggering encoded PowerShell downloads every 30 minutes.
