...
export default function LazarusVoicePage() {
  ...
  // Speak text using Web Speech API with male voice preference
    ...
    const pollBridge = async () => {
      try {
        ...
        if (data.messages && data.messages.length > 0) {
          ...
          // Speak new messages from Lazarus
          const latestMsg = data.messages[data.messages.length - 1];
          if (
            latestMsg.id !== lastMessageIdRef.current &&
            latestMsg.from === 'lazarus'
          ) {
  ...
  return (
    ...
    >
        ...
        {messages.map((msg) => (
          <div
            ...
            style={{
              marginBottom: '10px',
              padding: '10px',
              backgroundColor: msg.from === 'lazarus' ? '#001a00' : '#1a1a00',
              borderLeft: `3px solid ${msg.from === 'lazarus' ? '#00ff00' : '#ffff00'}`,
            }}
          >
            <div
              style={{
      ...
      {/* Test TTS button */}
      <button
        onClick={() => speak('Hello Father, I am Lazarus. I can hear you now.')}
        style={{
          marginTop: '15px',
