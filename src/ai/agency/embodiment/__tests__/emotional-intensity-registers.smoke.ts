...
console.log('Emotional Intensity Registers — Smoke Tests\n');

// ============================================================
// Test 1: Init creates all parameters
// ============================================================
{
  console.log('Test 1: Init creates all parameters');
  ...
  console.log('✓ All 6 registers initialized\n');
}
...
// ============================================================
{
  console.log('Test 2: Read returns current values');
  const registry = new ParameterRegistry();
  initEmotionalIntensityRegisters(registry);
  ...
  console.log('✓ Read returns all 6 values\n');
}
...
// ============================================================
{
  console.log('Test 3: Bounds are enforced');
  const registry = new ParameterRegistry();
  initEmotionalIntensityRegisters(registry);
  ...
  console.log('✓ Bounds enforced (min/max)\n');
}
...
// ============================================================
{
  console.log('Test 4: Cache works and TTL expires');
  const registry = new ParameterRegistry();
  initEmotionalIntensityRegisters(registry);
  clearCache();
  ...
  console.log('✓ Cache works with TTL\n');
}
...
// ============================================================
{
  console.log('Test 5: Snapshot function works');
  const registry = new ParameterRegistry();
  initEmotionalIntensityRegisters(registry);
  ...
  console.log('✓ Snapshot function works\n');
}
...
// ============================================================
{
  console.log('Test 6: Owner verification');
  const registry = new ParameterRegistry();
  initEmotionalIntensityRegisters(registry);
...
// ============================================================
{
  console.log('Test 7: UI metadata');
  const registry = new ParameterRegistry();
  initEmotionalIntensityRegisters(registry);
  ...
  console.log('✓ UI metadata is slider-tunable\n');
}
